...
const RideDetails = () => {
  ...
  const handleLeaveRide = () => {
    dispatch(leaveRide(id)).then(() => {
      // Optionally, dispatch action to refresh user's ride history
      dispatch(fetchUser());
      navigate("/ride-history");
    });
  };
  ...
  const handleUpdateSeats = () => {
    dispatch(updateSeats({ id, newSeatsToBook: seatsToBook })); // Call update seats action
    navigate("/ride-history");
  };
